...
class LineDetector(object):
    ...
    def process(self, image):
        ...
        result = self.merge_drawing(undistorted=undistorted,
                                    binary_warped=binary_warped,
                                    binary_unwarped=binary_unwarped,
                                    left_line=left_line,
    ...
    def merge_drawing(self, undistorted, binary_warped, binary_unwarped,
        ...
        unwarped_line_win[ploty, left_fitx] = [255, 0, 0]
        unwarped_line_win[ploty, right_fitx] = [0, 0, 255]
        unwarped_line_win =\
        ...
        panel2 = cv2.copyMakeBorder(unwarped_line_win, 10, 10, 5, 10,
                                    cv2.BORDER_CONSTANT, value=(255, 0, 0))
        info_panel = np.hstack((panel1, panel2))
        ...
        cv2.putText(undistorted, curvature_txt, (20, 40),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    1, (255, 255, 255), 2, cv2.LINE_AA)
        cv2.putText(undistorted, dtxt, (20, 100),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    1, (255, 255, 255), 2, cv2.LINE_AA)
